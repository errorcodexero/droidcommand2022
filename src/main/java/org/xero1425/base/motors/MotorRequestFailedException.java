...
public class MotorRequestFailedException extends Exception {
    ...
    public MotorRequestFailedException(XeroMotorController motor, String msg, REVLibError code) {
    ...
    /// \param msg a string describing the cause of the exception
    /// \param code the error code that occurred
    public MotorRequestFailedException(XeroMotorController motor, String msg, ErrorCode code) {
        super("motor '" + motor.getName() + "' - " + code.toString() + ":" + msg) ;
